                    Bitnami Magento Stack 1.9.1.1-0
                  ==============================
...
Magento is a web content management system (software for building and
maintaining a dynamic website) that keeps you behind the wheel. Magento's 
powerful feature-set means there's always a way to accomplish your vision.
Not only does it have all the features you'd expect: for instance galleries,
news, file downloads and community forums/chats, but it does so whilst
meeting the highest accessibility and professional standards. It is also
smart enough to go beyond page management, to automatically handle search
engine optimisation, and provide aggressive hack attack prevention. With
Magento, you get much more than just a Content Management System.

You can learn more about Magento at http://magento.com

The Bitnami Magento Stack is an installer that greatly simplifies the
installation of Magento and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. Magento Stack is distributed for free
...
Bitnami Magento Stack ships with the following software versions:
...
To install Bitnami Magento Stack you will need:
...
The Bitnami Magento Stack is distributed as a binary executable installer.
...
bitnami-magento-1.9.1.1-0-linux-installer.run on Linux or
bitnami-magento-1.9.1.1-0-linux-x64-installer.run on Linux 64 bit or
bitnami-magento-1.9.1.1-0-windows-installer.exe on Windows or
bitnami-magento-1.9.1.1-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-magento-1.9.1.1-0-linux.run
...
tool is intended to handle the administration of MySQL over the web.
...
protect other parts of the installation and to log-in in Magento. Please see 
the section named "Usernames and Passwords" later in this document.
...
alternate ports to use. After this screen, yo will be asked for the machine
...
'Installation Finished' page. You can choose to launch Bitnami Magento
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami Magento Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami Magento
Stack in /home/user/magento-1.9.1.1-0 on Linux or C:\Program Files\Bitnami Magento Stack
on Windows or /Applications/magento-1.9.1.1-0 on OS X and that you use port 8080 
for Apache on Linux or port 80 on Windows and 3306 for MySQL. 

6. STARTING AND STOPPING BITNAMI MAGENTO STACK
...
On Windows, you can start and stop Bitnami Magento Stack using the shortcuts created
...
installation directory:
	...
	apps/
	  magento/: Magento application folder
	    conf/: Magento Apache configuration files
	    htdocs/: Magento PHP application files
	    scripts/: tools to install/uninstall Magento
	    temp/: a temporally folder created after installation (you can delete it safely)
	  phpMyAdmin/: phpMyAdmin application folder (optional)

8. DEFAULT USERNAMES AND PASSWORDS

The Magento administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
Magento administrative user password.

The phpMyAdmin administrative user is 'root'.

For Virtual Appliances and AMIs you can check the default user and password
in the Bitnami download page. The administrator user is 'user' and the
password is 'bitnami1'


9. TROUBLESHOOTING

This version of the Bitnami Magento stack is a preview version, and as
...
/home/user/magento-1.9.1.1-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Magento Stack\apache2\logs\error.log on Windows or
/Applications/magento-1.9.1.1-0/apache2/logs/error.log.
...
# I can't log in as Administrator (or I can't find the administration panel)

The administrative interface of Magento is hidden. You can access it by going
to http://your_domain/magento/index.php/admin

You can also find a link to it in the main page of the stack
(http://your_address/) or in the applications page
(http://your_address/applications.html), if you installed Magento as a module.

For any problem related to Magento, please visit 
...
Magento is distributed under the Common Public Attribution License Version 1.0 (CPAL)
which is located at: http://www.opensource.org/licenses/cpal_1.0
